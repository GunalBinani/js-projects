...
var setMinutesArray = [90,90,90,180,90,90,180,230,180,90,-90,0,
        ...
        90,-90,0,0,-90,90,0];
var setHoursArray = [180,-90,-90,-90,-180,-90,-90,230,0,180,180,180,180,0,-90,
180,230,0,180,180,180,230,0,180,230,0,180,180,180,230,0,180,230,0,0,0,180,
...
setTimeout(function(){
    for(var j=0;j<setMinutesArray.length;j++){
        minuteHands[j].setAttribute('style','transition: '+createRandomNumbers(5,10)+'s; transform: roate('+setMinutesArray[j]+'deg)');
    }
    for(var j=0;j<setHoursArray.length;j++){
        hourHands[j].setAttribute('style','transition: '+createRandomNumbers(5,10)+'s; transform: roate('+setHoursArray[j]+'deg)');
    }
},5000);
